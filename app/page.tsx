    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full max-w-2xl px-4">
        ...
        <div className="p-4 sm:p-8 text-black rounded-lg text-center transition cursor-pointer border hover:bg-zinc-100 flex flex-col items-center justify-center">
          ...
          <EditCalendar sx={{ color: pink[500], fontSize: { xs: '1.25rem', sm: '1.5rem' } }} />
          </div>
          <h2 className="mt-2 sm:mt-4 text-sm sm:text-base">Create Event</h2>
          <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500">Plan a new event</p>
        </div>
        </Link>
        ...
        <div className="p-4 sm:p-8 text-black rounded-lg text-center transition cursor-pointer border hover:bg-zinc-100 flex flex-col items-center justify-center">
          ...
          <SchoolIcon sx={{ color: orange[500], fontSize: { xs: '1.25rem', sm: '1.5rem' } }} />
          </div>
          <h2 className="mt-2 sm:mt-4 text-sm sm:text-base">Your Class</h2>
          <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500">View your current class</p>
        </div>
        </Link>
        ...
        <div className="p-4 sm:p-8 text-black rounded-lg text-center transition cursor-pointer border hover:bg-zinc-100 flex flex-col items-center justify-center">
          ...
          <CalendarMonthIcon sx={{ color: blue[500], fontSize: { xs: '1.25rem', sm: '1.5rem' } }} />
          </div>
          <h2 className="mt-2 sm:mt-4 text-sm sm:text-base">List of Events</h2>
          <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500">See upcoming events</p>
        </div>
        </Link>
        ...
        <div className="p-4 sm:p-8 text-black rounded-lg text-center transition cursor-pointer border hover:bg-zinc-100 flex flex-col items-center justify-center">
          ...
          <AccountCircleIcon sx={{ color: red[500], fontSize: { xs: '1.25rem', sm: '1.5rem' } }} />
          </div>
          <h2 className="mt-2 sm:mt-4 text-sm sm:text-base">Your Profile</h2>
          <p className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500">View your profile details</p>
        </div>
        </Link>
      </div>
      </div>
