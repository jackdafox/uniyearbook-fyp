  ...
  return (
    <div className="w-full">
      ...
      <div className="space-y-1">
        <h1 className="text-lg md:text-xl font-semibold tracking-tight">Description</h1>
        <h2 className="tracking-tight text-sm md:text-base">{event.description}</h2>
      </div>
      <div className="space-y-1">
        <h1 className="text-lg md:text-xl font-semibold tracking-tight">Location</h1>
        <h2 className="tracking-tight text-sm md:text-base">{event.location}</h2>
      </div>
      <div className="space-y-1">
        <h1 className="text-lg md:text-xl font-semibold tracking-tight">Date</h1>
        <h2 className="tracking-tight text-sm md:text-base">{convertDate(event.start_date)}</h2>
      </div>
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionContent>
          ...
          {comments?.map((comment) => (
            ...
            <div className="flex flex-col items-start">
              ...
              <h1 className="font-bold text-sm md:text-base">{comment.User.first_name}</h1>
        ...
        <AccordionContent>
          ...
          {participant?.map((participants) => (
            <div key={participants.User.id} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
